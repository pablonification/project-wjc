          ...
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-8">
              ...
              <p className="text-gray-300 text-b1">
                Pembayaran Anda tidak dapat diproses. Silakan coba lagi atau hubungi customer service.
              </p>
            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-t border-gray-700 pt-4">
                    <div className="text-sm text-gray-400">
                      <p><strong>Status:</strong> {order.status === 'CANCELLED' ? 'Dibatalkan' : order.status}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              <p className="text-gray-300 text-b1">
                Pesanan Anda belum berhasil diproses. Anda dapat mencoba melakukan pembayaran lagi atau menghubungi customer service untuk bantuan.
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button 
                  onClick={() => window.location.href = order?.xenditPaymentUrl}
                  className="bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-6 rounded-lg"
                  disabled={!order?.xenditPaymentUrl}
                >
                  Coba Bayar Lagi
                </button>
                <Link href="/merchandise" className="bg-gray-600 hover:bg-gray-700 text-white font-bold py-3 px-6 rounded-lg">
                  Kembali ke Toko
                </Link>
              </div>
            </div>
